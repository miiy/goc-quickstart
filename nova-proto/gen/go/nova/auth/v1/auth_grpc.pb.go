...
const (
	AuthService_VerifyToken_FullMethodName    = "/nova.auth.v1.AuthService/VerifyToken"
	AuthService_Register_FullMethodName       = "/nova.auth.v1.AuthService/Register"
	AuthService_UsernameCheck_FullMethodName  = "/nova.auth.v1.AuthService/UsernameCheck"
	AuthService_EmailCheck_FullMethodName     = "/nova.auth.v1.AuthService/EmailCheck"
	AuthService_PhoneCheck_FullMethodName     = "/nova.auth.v1.AuthService/PhoneCheck"
	AuthService_Login_FullMethodName          = "/nova.auth.v1.AuthService/Login"
	AuthService_SendSmsCode_FullMethodName    = "/nova.auth.v1.AuthService/SendSmsCode"
	AuthService_PhoneAuth_FullMethodName      = "/nova.auth.v1.AuthService/PhoneAuth"
	AuthService_MpLogin_FullMethodName        = "/nova.auth.v1.AuthService/MpLogin"
	AuthService_RefreshToken_FullMethodName   = "/nova.auth.v1.AuthService/RefreshToken"
	AuthService_ChangePassword_FullMethodName = "/nova.auth.v1.AuthService/ChangePassword"
	AuthService_Logout_FullMethodName         = "/nova.auth.v1.AuthService/Logout"
)
...
type AuthServiceClient interface {
	// VerifyToken validates an access token (signature + revocation + active user).
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nova.auth.v1.AuthService",
	...
	Metadata: "nova/auth/v1/auth.proto",
}
