...
// GetNewPasswordConfirmation returns the NewPasswordConfirmation field value
func (o *ChangePasswordRequest) GetNewPasswordConfirmation() string {
	...
	return o.NewPasswordConfirmation
}

// GetNewPasswordConfirmationOk returns a tuple with the NewPasswordConfirmation field value
// and a boolean to check if the value has been set.
func (o *ChangePasswordRequest) GetNewPasswordConfirmationOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NewPasswordConfirmation, true
}

// SetNewPasswordConfirmation sets field value
func (o *ChangePasswordRequest) SetNewPasswordConfirmation(v string) {
	o.NewPasswordConfirmation = v
}
...
func (o ChangePasswordRequest) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["new_password_confirmation"] = o.NewPasswordConfirmation
