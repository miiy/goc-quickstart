...
import (
	...
	uploadv1 "github.com/miiy/goc-quickstart/upload-service/gen/go/blog/upload/v1"
	"github.com/miiy/goc-quickstart/upload-service/internal/di"
...
var protectedMethods = map[string]struct{}{
	uploadv1.UploadService_CreateUpload_FullMethodName: {},
}
...
func main() {
	...
	err = server.Run(ctx, server.Options{
		...
		RegisterService: func(s server.GRPCServer) {
			...
			uploadv1.RegisterUploadServiceServer(s, app.UploadService())
