...
import (
	...
	"github.com/miiy/goc-quickstart/nova-user/internal/app"
	"github.com/miiy/goc-quickstart/nova-user/internal/config"
	userRepo "github.com/miiy/goc-quickstart/nova-user/internal/repository"
	userSrv "github.com/miiy/goc-quickstart/nova-user/internal/service"
...
func InitApp(conf string) (*app.App, func(), error) {
	panic(wire.Build(
		...
		wire.NewSet(userRepo.NewUserRepository, userSrv.NewUserServiceServer),
		app.NewApp,
	))
}
