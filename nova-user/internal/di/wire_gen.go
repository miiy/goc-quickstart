...
import (
	...
	"github.com/miiy/goc-quickstart/nova-user/internal/service"
...
func InitApp(conf string) (*app.App, func(), error) {
	...
	userServiceServer := service.NewUserServiceServer(zapLogger, userRepository)
	appApp := app.NewApp(configConfig, dbDB, universalClient, loggerLogger, userServiceServer)
	return appApp, func() {
	}, nil
}
