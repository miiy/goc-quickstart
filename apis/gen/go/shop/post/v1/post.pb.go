...
import (
	_ "github.com/miiy/goc-quickstart/apis/gen/go/protoc-gen-openapiv2/options"
...
const file_shop_post_v1_post_proto_rawDesc = "" +
	...
	"\fGetPostError\x12\x1c.post.v1.GetPostErrorRequest\x1a\x1d.post.v1.GetPostErrorResponse\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/api/v1/post-errorB\x98\x03\x92A\xff\x01\x12\xb5\x01\n" +
	"\bShop API\"K\n" +
	...
	"\vcom.post.v1B\tPostProtoP\x01Z>github.com/miiy/goc-quickstart/apis/gen/go/shop/post/v1;postv1\xa2\x02\x03PXX\xaa\x02\aPost.V1\xca\x02\aPost\\V1\xe2\x02\x13Post\\V1\\GPBMetadata\xea\x02\bPost::V1b\x06proto3"
