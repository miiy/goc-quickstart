...
import (
	...
	"github.com/miiy/goc-quickstart/web/internal/app"
...
func provideSessionOptions(config *config.Config) sessions.Options {
	return sessions.Options{
		...
		Secure:   sessionCookieSecure(config.App.Env, config.Session.Name),
		HttpOnly: true,
