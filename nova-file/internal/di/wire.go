...
import (
	...
	"github.com/miiy/goc-quickstart/nova-file/internal/app"
	"github.com/miiy/goc-quickstart/nova-file/internal/config"
	fileRepo "github.com/miiy/goc-quickstart/nova-file/internal/repository"
	fileSrv "github.com/miiy/goc-quickstart/nova-file/internal/service"
...
func InitApp(conf string) (*app.App, func(), error) {
	panic(wire.Build(
		...
		wire.NewSet(provideStorageConfig, fileRepo.NewFileRepository, fileSrv.NewFileServiceServer),
		app.NewApp,
	))
}
