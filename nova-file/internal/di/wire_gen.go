...
import (
	...
	"github.com/miiy/goc-quickstart/nova-file/internal/service"
...
func InitApp(conf string) (*app.App, func(), error) {
	...
	fileServiceServer := service.NewFileServiceServer(zapLogger, fileRepository, storage)
	appApp := app.NewApp(configConfig, dbDB, universalClient, loggerLogger, fileServiceServer)
	return appApp, func() {
	}, nil
}
