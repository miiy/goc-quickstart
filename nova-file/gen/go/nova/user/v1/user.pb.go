...
const file_nova_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x17nova/user/v1/user.proto\x12\fnova.user.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xc1\x03\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x12.nova.user.v1.UserR\x05users\"\x92\x01\n" +
	"\x11UpdateUserRequest\x12\x13\n" +
	"\x02id\x18\x01 \x01(\x03B\x03\xe0A\x02R\x02id\x12+\n" +
	"\x04user\x18\x02 \x01(\v2\x12.nova.user.v1.UserB\x03\xe0A\x02R\x04user\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"<\n" +
	"\x12UpdateUserResponse\x12&\n" +
	"\x04user\x18\x01 \x01(\v2\x12.nova.user.v1.UserR\x04user\"C\n" +
