...
const file_nova_post_v1_post_proto_rawDesc = "" +
	...
	"\x04post\x18\x01 \x01(\v2\x12.nova.post.v1.PostB\x03\xe0A\x02R\x04post\"<\n" +
	"\x12CreatePostResponse\x12&\n" +
	"\x04post\x18\x01 \x01(\v2\x12.nova.post.v1.PostR\x04post\"\x92\x01\n" +
	"\x11UpdatePostRequest\x12\x13\n" +
	"\x02id\x18\x01 \x01(\x03B\x03\xe0A\x02R\x02id\x12+\n" +
	"\x04post\x18\x02 \x01(\v2\x12.nova.post.v1.PostB\x03\xe0A\x02R\x04post\x12;\n" +
